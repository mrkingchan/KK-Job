...
//
//        UIButton *btn = [UIFactory initBorderButtonWithFrame:CGRectMake(0,0, 100, 40) title:[NSString stringWithFormat:@"%@\n%@",[annotation title],[annotation subtitle]] textColor:[UIColor whiteColor] font:systemOfFont(13) cornerRadius:10 bgColor:kNavBarTintColor borderColor:[UIColor groupTableViewBackgroundColor] borderWidth:0.5 tag:current.index target:self action:@selector(btnAction:)];
